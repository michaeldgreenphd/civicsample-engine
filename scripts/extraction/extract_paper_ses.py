...
each manuscript through three LLMs (small / medium / large tier) to compare
...
# The extraction prompt lives in prompts/paper_ses.txt so it can be edited
